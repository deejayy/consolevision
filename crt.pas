...
{                                                       }
{          Additional work and some procedures:         }
{                  2001 - 2002 DeeJayy                  }
{*******************************************************}
  ...
  begin
    ...
    repeat
      ...
      if InputRec.Event.KeyEvent.bKeyDown then
        ...
        256 : begin
                Result := Chr( InputRec.Event.KeyEvent.wVirtualKeyCode );
                Exit;
              end
          else begin
                 Result := InputRec.Event.KeyEvent.AsciiChar;
...
//    RHandle := STD_INPUT_HANDLE;
//    WHandle := STD_OUTPUT_HANDLE;
